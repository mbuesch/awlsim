...
timer_ticks_per_scl = timer_period_us / scl_period_us
...
print("};")
print("")
print("static const enum clkstretch_release_hint __flash clkstretch_release_hint_table[0xFF + 1] = {")
for timer_cnt in range(0xFF):
