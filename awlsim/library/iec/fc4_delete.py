...
class Lib__IEC__FC4_DELETE(AwlLibFC):
	...
	interfaceFields = {
		BlockInterfaceField.FTYPE_IN	: (
			...
			BlockInterfaceField(name = "L",
					    dataType = AwlDataType.makeByName("INT")),
			BlockInterfaceField(name = "P",
					    dataType = AwlDataType.makeByName("INT")),
		),
		...
		BlockInterfaceField.FTYPE_TEMP	: (
			...
			BlockInterfaceField(name = "MAX_COPY_LEN",
					    dataType = AwlDataType.makeByName("INT")),
			BlockInterfaceField(name = "IN_END",
					    dataType = AwlDataType.makeByName("DWORD")),
			BlockInterfaceField(name = "DEL_START",
					    dataType = AwlDataType.makeByName("DWORD")),
			BlockInterfaceField(name = "DEL_END",
					    dataType = AwlDataType.makeByName("DWORD")),
			BlockInterfaceField(name = "RET_VAL_START",
					    dataType = AwlDataType.makeByName("DWORD")),
		),
	}
