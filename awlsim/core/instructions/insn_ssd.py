...
class AwlInsn_SSD(AwlInsn): #+cdef
	...
	def __init__(self, cpu, rawInsn=None, **kwargs):
		AwlInsn.__init__(self, cpu, AwlInsn.TYPE_SSD, rawInsn, **kwargs)
...
#@cy		cdef int64_t count
		...
		accu1 = self.cpu.accu1.getSignedDWord() #@nocy
#@cy		accu1 = <int64_t>(<int32_t>(self.cpu.accu1.getSignedDWord()))
		if self.opCount:
