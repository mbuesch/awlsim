...
class PiXtendV2S(PiXtendV2Core):
    ...
    def retain_data_out(self, value):
        ...
        if len(value) < 32 or len(value) > 32:
    ...
    def _pack_spi_data(self):
        ...
        for i in range(9, 65, 1):
            ...
            self._SPI_DATA[65] = crc_sum & 0xFF  # CRC Low Byte
            self._SPI_DATA[66] = (crc_sum >> 8) & 0xFF  # CRC High Byte
